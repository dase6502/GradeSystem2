    ...
    */   
    ...
    public void ShowGrade(String ID) {
        ...
        try {        
            ...
            PrintMid(ID);
            PrintFinal(ID);
            int temp = (int) (Integer.parseInt(data.mapFinal.get(ID).toString()) * mul[4] + Integer.parseInt(data.mapMid.get(ID).toString()) *mul[3] + Integer.parseInt(data.mapLab1.get(ID).toString()) * mul[0] + Integer.parseInt(data.mapLab2.get(ID).toString()) * mul[1] + Integer.parseInt(data.mapLab3.get(ID).toString()) *mul[2] + 0.5);
            PrintTotal(temp);
        } catch (Exception e) {
